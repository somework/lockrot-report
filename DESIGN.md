...
| PD-TIMELINE-11              | a minimum stub pinned months of releases to one spot left of today     | every dot at its true date, a recent one on the rule; a year beside a guide moves aside; one caption says "ago"     |
