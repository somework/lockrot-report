...
| PD-DETAIL-8                 | three ages on one screen; the rung said "only reached through" one way in  | the answer quotes the fact's own age; "Newest release · on 2.x"; one `waysIn` list for sentence, rung and chain                               |
