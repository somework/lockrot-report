...
| PD-BASELINE-1               | a baseline showed only as rail counts and a Run-list sentence                                                                                                                                                                  | a serif delta line over Findings: new, worsened, accepted as toggles of the Since filter; the entries gone from the lock under it                                                                                                                                                                                                                                                                                                                  |
