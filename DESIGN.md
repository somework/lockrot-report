...
| PD-DETAIL-12                | "Signals": equal boxes of the fired ones; quiet checks never named          | "Checks" after the ladder: S1–S10 named in a 5×2 strip, tally, ids-only quiet line, fired rows by level; each data object one field a line    |
